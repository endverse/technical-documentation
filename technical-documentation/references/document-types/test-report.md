...
Required: objective/object/scope; environment/version/data; pass and exit criteria; passed/failed/not-run results; defects/blockers; residual risks; explicit meet/not-meet conclusion. Record untested items when they affect the conclusion, together with their impact; do not use scope sections to list editorial exclusions. Optional: strategy, metrics, evidence appendix. Exclude execution diary, raw logs, and conclusions without criteria. Keep plan, cases, report, and defect list separate when they are independently maintained.
