...
Check: risky actions have a clear stop, validation, and recovery path. Unknown owner, approval/application path, or acceptance criterion is surfaced as a gap and paused on (see common rules), not filled with on-the-spot-confirmation filler.
